...
public class AlignmentFinal {
  ...
  public Process run(String loc1, String loc2) {
    ...
    File f = new File("bwa/");
    // File f1 = new
    // File("/home/robinronson96/workspace/DNAnglerPipeline/Output/SAM");
    ...
    for (int i = 1; i <= size; i++) {
      ...
      String[] commands = {"./bwa",
                           ...
                           "-t",
                           "40",
                           "../Output/HomologyBlocks/" + i + ".fasta",
                           loc1,
                           loc2,
                           "-o",
                           "../Output/SAM/aln-pe" + i + ".sam"};
      pb.command(commands);
    ...
    for (int i = 1; i <= max; i++) {
      ...
      String[] command = {"./samtools", "sort",
                          "../Output/SAM/aln-pe" + i + ".sam", "-o",
