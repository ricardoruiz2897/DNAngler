...
/****This the the Main Class that sequentally excecutes each process in the
 * DNAngler tool.******/
...
public class Main {
  ...
  public static void main(String[] args) throws InterruptedException {
    ...
    Commannds: pb.command("./metaspades.py", "-t 20", "--pe1-1", loc1,
    "--pe1-2", loc2, "-o", "../../Output");
    */
    ...
    processExitDetector.addProcessListener(new ProcessListener() {
      public void processFinished(Process process) { printOutput(); }
    });
    processExitDetector.run();
  }

  /*This function is invoked after the Metaspades assembly is complete and
  prints out the scaffolds.fasta file
  ...
  */
  ...
  /*This section runs the BLAST program and creates the BLAST Database after
  which is calls the function that
  invokes the BLASTn program.
  Commands: "./makeblastdb", "-in",  "../../Output/scaffolds.fasta", "-dbtype",
  "nucl"
  In order to gain more insight into the working of the BLAST program please
  open the BLAST.java file*/
  public static void blast() {
    ...
    ProcessExitDetector processExitDetector = new ProcessExitDetector(p);
    processExitDetector.addProcessListener(new ProcessListener() {
      public void processFinished(Process process) { finalBLAST(); }
    });
    processExitDetector.run();
  }

  /*This section runs the BLAST Program. After which it invokes the
  blastConverter() function.
  Commands: {"./blastn", "-query", "../../Output/scaffolds.fasta", "-db",
  "../../Output/scaffolds.fasta", "-outfmt", "6 qseqid qstart qend sseqid sstart
  send", "-out", "../../Output/OPblast"}
  In order to gain more insight into the working of the BLAST program please
  open the BLASTFinal.java file.
  */
  ...
  This section runs the blastConverter function which is designed to generate
  the Homology Blocks and stored in Output/Homology Blocks.
  For more information into the workings of this function please visit the
  BLASTConvert.java file.
  After the creation of the Homology Block, this function calls the indexing
  function of Burrows-Wheeler Aligner.
  */
  ...
  After all Homology Block are indexed, the function calls the Burrows-Wheeler
  Aligner function finalalignment()
  */
  ...
  /*This section performs the Burrows-Wheeler Alignment and stores the resulting
  SAM files in Output/SAM
  Commands Used: {"./bwa","mem", "../Output/HomologyBlocks/"+i+".fasta", loc1,
  loc2, "-o", "../Output/SAM/aln-pe"+i+".sam"};
  ...
  */
  ...
  /*This function sorts the .sam using samtools to .bam files and stores the
  resulting output into Output/BAM folder.
  Commands Used: {"./samtools","sort", "../Output/SAM/aln-pe"+i+".sam", "-o",
  "../Output/BAM/aln-pe"+i+".bam"}
  ...
  */
  ...
  // This function indexes the the resulting bam file for display in the tablet
  // software and then terminates the program.
